...
<body>
<!-- 예약 아이디 세션값 받아오기:(${reservationEmail}) -->
<input type="hidden" id="emailId" value="${reservationEmail}">
<!-- 예약 번호 받아오기:(${reservno}) -->
<input type="hidden" id="reservno" value="${reservno}">
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="./myReservation.do" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
				...
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating">
							...
							<input type="radio" name="rating" value="1" class="rating_rdo" title="1점">
							<span class="span"></span>
							<input type="radio" name="rating" value="2" class="rating_rdo" title="2점">
							<span class="span"></span>
							<input type="radio" name="rating" value="3" class="rating_rdo" title="3점" >
							<span class="span"></span>
							<input type="radio" name="rating" value="4" class="rating_rdo" title="4점">
							<span class="span"></span>
							<input type="radio" name="rating" value="5" class="rating_rdo" title="5점">
							<span class="span"></span>
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						<label class="btn_upload">
							...
							<span id="addFileBtn" class="text_add_photo">사진 추가</span>
						</label>
						<input type="file" name="filename1" class="file" id="file0" style="display: none;" accept="image/*">
						<input type="file" name="filename2" class="file" id="file1" style="display: none;" accept="image/*">
						<input type="file" name="filename3" class="file" id="file2" style="display: none;" accept="image/*">
				...
				<div class="box_bk_btn">
					<button id="setReview" class="bk_btn"><span class="btn_txt">리뷰 등록</span></button>
				</div>
				<!-- //리뷰 등록 -->
			</div>
		</div>
