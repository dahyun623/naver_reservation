...
<script type="text/javascript" src="./js/bookingLoginForm.js"></script>
</head>
<body class="biz  ko">
	...
	<a href="./main.do" class="top_info_close" data-tst_alt_close="0">
	...
	<div class="_view_content" ui-view="content" id="container">
		...
		<div class="booking_login">
			<h1 class="login_header">
				<a href="./main.do" class="nbooking_logo spr_bi txt_logo"> <span
			...
			<div>
				<form name="confirm_form" class="ng-pristine ng-valid" id="form1"
					action="./bookingLogin.do" method="get">
					...
					<div class="login_form">
						<label class="label_form" for="resrv_id"
							...
							placeholder="example@naver.com" title="예매자이메일">
					</div>
	...
	<footer aria-hidden="false">
		...
		<!---->
		<!---->
	</footer> <dialog-alert> <!----> </dialog-alert> </app>
